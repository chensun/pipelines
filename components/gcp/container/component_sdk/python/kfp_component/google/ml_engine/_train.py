...
def train(project_id,
  ...
  """Creates a MLEngine training job.
    ...
    Args:
        ...
        package_uris (list): Required. The Google Cloud Storage location of the
        ...
        job_dir (str): A Google Cloud Storage path in which to store training
          ...
          your TensorFlow program as the '--job-dir' command-line argument. The
          benefit of specifying this field is that Cloud ML validates the path
          for use in training.
        python_version (str): Optional. The version of Python used in training.
          ...
          when runtimeVersion is set to '1.4' and above. Python '2.7' works with
          all supported runtime versions.
        runtime_version (str): Optional. The Cloud ML Engine runtime version to
          use for training. If not set, Cloud ML Engine uses the default stable
          version, 1.0.
        ...
        job_id (str): the created job_id, takes precedence over generated job id
          if set.
