...
class ClientTest(unittest.TestCase):
  ...
  def test_job_id_parameters_override(self, mock_load_json,
    ...
    with mock.patch.object(
      ...
      golden['runtimeConfig']['gcsOutputDirectory'] = 'gs://bucket/new-blob'
      golden['runtimeConfig']['parameters']['text'] = {
          'stringValue': 'Hello test!'
      }
      mock_submit.assert_called_once_with(job_spec=golden, job_id='my-new-id')
